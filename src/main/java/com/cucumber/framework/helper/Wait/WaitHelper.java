...
public class WaitHelper extends GenericHelper {
	...
	public void untilPageLoadComplete(WebDriver driver) {
		try {
			untilPageLoadComplete(reader.getImplicitWait());
		} catch (Exception e) {
			// TODO Auto-generated catch block
			System.out.println("Error in untilPageloadComplete:"+e.getMessage());
		}
	}
	...
	public void until(WebDriver driver, Function<WebDriver, Boolean> waitCondition){
		until(driver, waitCondition, reader.getImplicitWait());
	}
	...
	public void loadingWait(WebDriver driver, WebElement visibleloader, By invisibleloader) {
		WebDriverWait wait = new WebDriverWait(driver, 5000L);
	    wait.until(ExpectedConditions.visibilityOf(visibleloader)); // wait for loader to appear
	    wait.until(ExpectedConditions.invisibilityOfElementLocated(invisibleloader)); // wait for loader to disappear
	}
}
